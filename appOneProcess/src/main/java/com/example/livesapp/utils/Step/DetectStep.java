...
public class DetectStep implements SensorEventListener {
    ...
    private static final String TAG = "DetectStep";
    ...
    DetectStep(Context context, StepCounter stepCounter) {
...
//    【Sensor流程（一）】https://blog.csdn.net/qq_41663117/article/details/117711651
//    该方法仍然运行在app进程中，并不在SystemServer进程中（当Sensor对应的套接字中产生数据时，会从native层被唤醒执行）
    @Override
