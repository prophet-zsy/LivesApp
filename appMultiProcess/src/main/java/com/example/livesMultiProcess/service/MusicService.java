...
import com.example.livesMultiProcess.network.music.DownloadMusicNetProxy;
import com.example.livesMultiProcess.network.music.GetMusicListProxy;
import com.example.livesMultiProcess.utils.MediaPlayerManager;
...
// todo Service默认运行在主线程中，所以不应在service中做太多耗时任务，应在service中使用子线程完成耗时任务
// todo 尽管service在单独的进程中，也应该按上述规则来做
